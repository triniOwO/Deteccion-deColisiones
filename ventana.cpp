...
int main()
{
    ...
    CircleShape triangulo(radio_triangulo,3);//tamaño del triangulo
    triangulo.setPosition(x_triangulo, y_triangulo);//posicion del triangulo
    triangulo.setFillColor(Color::Red);//color de relleno del triangulo
    ...
    RectangleShape rectangulo(Vector2f(20, 60));//Tamaño del rectangulo 20x60
    rectangulo.setPosition(x_rectangulo, y_rectangulo);//posicion del recangulo
    rectangulo.setFillColor(Color::Yellow);//color de relleno del rectangulo
  ...
  //obtenemos los limites a partir de las cordenadas del triangulo y el rectangulo
